...
- **Visão executiva no dashboard sem perder fluxo operacional:** era necessário enxergar números por etapa sem sair da página do board. **Solução:** cards responsivos por etapa com contagem, barra de distribuição por estágio e atalho rápido para o Kanban na própria tela.
...
- [x] Dashboard com cards por etapa, distribuição visual por barras e link rápido para a seção do Kanban
